...
import { InvalidAuthenticationCredentials, UserAuthenticationCredentialsVO } from '../../../domain';
...
export class SigninCommandHandler implements ICommandHandler<SigninCommand> {
    ...
    async execute(command: SigninCommand): Promise<Result<UserAuthenticationCredentialsVO, ExceptionBase>> {
