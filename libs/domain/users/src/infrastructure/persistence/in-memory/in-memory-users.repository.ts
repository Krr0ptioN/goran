...
export class InMemoryUsersRepository implements UsersRepository {
  ...
  async insertOne(
    ...
    const userByEmail = await this.findOneByEmail(userValue.getProps().email);
    ...
    return Ok(this.mapper.toDomain(this.users[newLength - 1]));
  }
  ...
  async updateEmail(
    ...
    return Some(this.mapper.toDomain(this.users[userIndex]));
  }
